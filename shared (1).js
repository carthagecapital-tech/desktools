  ...
  if (!isHome) {
    ...
    if (catPages.indexOf(pageSlug) === -1 && pageSlug) {
      ...
      if (toolData && TAG_TO_CAT[toolData.tag]) {
        ...
        breadcrumb.innerHTML = '<a href="/all-tools">Tools</a> <span class="bc-sep">/</span> <a href="' + cat.url + '">' + cat.name + '</a> <span class="bc-sep">/</span> <span class="bc-current">' + toolData.name + '</span>';
